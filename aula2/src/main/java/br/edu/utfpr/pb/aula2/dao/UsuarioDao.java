...
public class UsuarioDao {
    ...
    //select * from Usuario where descricao like '%cat%'
    
    public List<Usuario> findByDescricaoLike(String descricao){
        Query query = em.createQuery("select c from Usuario c where c.descricao like :descricao");
