...
public class PermissaoDao {
    ...
    //select * from Permissao where descricao like '%cat%'
    
    public List<Permissao> findByDescricaoLike(String descricao){
        Query query = em.createQuery("select c from Permissao c where c.descricao like :descricao");
